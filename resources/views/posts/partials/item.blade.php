<li class="flex items-center px-3 hover:bg-green-100  border-b border-gray-200">
    ...
    <a class="flex-grow py-3 block truncate text-sm sm:text-base" href="{{ route('admin.posts.edit', $post) }}">{{ $post->title }}</a>
