...
function toggleCodeBlock (editor) {
  ...
  function insertFencingAtSelection (cm, cur_start, cur_end, fenceCharsToInsert) {
    ...
    var end_line_sel = cur_end.line + 1;
    var sel_multi = cur_start.line !== cur_end.line;
    var repl_start = fenceCharsToInsert + "\n";
    var repl_end = "\n" + fenceCharsToInsert;
    if (sel_multi) {
      end_line_sel++;
    }
  ...
  var is_code = code_type(cm, cur_start.line, line, tok);
  ...
  if (is_code === "single") {
    ...
    var next_line_last_tok = next_line && cm.getTokenAt({
      line: block_end + 1,
      ch: next_line.text.length - 1
    });
    var next_line_indented = next_line_last_tok && token_state(next_line_last_tok).indentedCode;
...
EasyMDE.prototype.uploadImage = function (file, onSuccess, onError) {
  ...
  if (self.options.imageCSRFToken) {
    formData.append("_token", self.options.imageCSRFToken);
  }
